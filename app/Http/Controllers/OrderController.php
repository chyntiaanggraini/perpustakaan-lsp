...
return view('admin.Order.create' , compact(['books',
...
return redirect('/orders')->with('success', 'Order has been
...
$books = Book::all();
$anggotas = anggota::all();
return view('admin.Order.update', compact('order', 'books',
'anggotas'));
}
/**
